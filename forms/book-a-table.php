<?php
  ...
  */
  ...
  $book_a_table->add_message( $_POST['name'], 'İsim');
  $book_a_table->add_message( $_POST['email'], 'Email');
  $book_a_table->add_message( $_POST['phone'], 'Telefon', 4);
  $book_a_table->add_message( $_POST['date'], 'Tarih', 4);
  $book_a_table->add_message( $_POST['time'], 'Saat', 4);
  $book_a_table->add_message( $_POST['people'], 'Kişi sayısı', 1);
  $book_a_table->add_message( $_POST['message'], 'Mesaj');
